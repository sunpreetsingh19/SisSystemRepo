...
public class StudentSearchResult extends JFrame implements ActionListener {
	...
	public String studentName;  // =AdminDashboard.studentSearchName;
	
	public String studentIdSearched;   //= AdminDashboard.studentSearchId;
	//String studentIdSearchedByName= StudentSearchByName.studentSearchID;
	public String studentProgram;
	
//	String StudentIDByName= StudentSearchByName.studentSearchID;
	
	public StudentSearchResult(String studentName, String studentId,String program) {
		this.studentName=studentName;
		studentIdSearched= studentId;
	...
	public StudentSearchResult() {*/
		...
		studentIdLabel.setText(studentIdSearched);
		...
		studentProgramLabel.setText( studentProgram/*AdminDashboard.studentSearchProgram*/);
	...
	if(e.getSource()==btnCancel) {
		...
		TermEnrollmentCourse enrollmentTerm= new TermEnrollmentCourse(studentName, studentIdSearched);
	...
	public void courseTableData(){
		...
		try {
			...
			String sql = "Select * from course_enrollment Where student_id='"+ studentIdSearched +"'";
