...
public class TermEnrollmentCourse extends JFrame implements ActionListener {
	...
	public TermEnrollmentCourse(String studentName,String studentId) {
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==btnSelect) {
			...
			CourseEnroll enroll= new CourseEnroll(term, StudentId);
			dispose();
		}
